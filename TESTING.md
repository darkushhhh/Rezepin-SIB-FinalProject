...
Для примера возьмем страницу `/include/admins.php`, которую удалось обнаружить в директории сервера.
...
Исходный код страницы `/include/admins.php` : [admins.php](other/code/admins_code.txt).
